...
class TestConfig(Config):
    ...
    CHATBOT_SOURCE = "management-chatbot-test"  # isolate test rows from real seed data by chatbot_source
...
def _cleanup_test_rows():
    ...
    try:
        with conn.cursor() as cur:
            ...
            cur.execute("DELETE FROM management_reports WHERE report_ref LIKE 'RPTTEST%'")
    finally:
        conn.close()
