  ...
  document.querySelectorAll(".hitl-approve-btn").forEach((btn) => {
    btn.addEventListener("click", async () => {
      ...
      try {
        ...
        resultDiv.innerHTML = `<span class="text-success"><i class="bi bi-check-circle"></i> Committed as claim #${data.entity_ref_id} (${data.status}) — refresh to update the list.</span>`;
      } catch (e) {
