...
class TestConfig(Config):
    ...
    CHATBOT_SOURCE = "callcenter-chatbot-test"  # isolate test rows from real seed data by chatbot_source
...
def _cleanup_test_rows():
    ...
    try:
        with conn.cursor() as cur:
            ...
            cur.execute("DELETE FROM call_center_logs WHERE call_notes = 'TEST_ROW_SAFE_TO_DELETE'")
    finally:
        conn.close()
