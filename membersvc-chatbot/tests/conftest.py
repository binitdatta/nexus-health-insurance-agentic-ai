...
class TestConfig(Config):
    ...
    DEPT_CODE = "MEMBERSVC"
    CHATBOT_SOURCE = "membersvc-chatbot-test"  # isolate test rows from real seed data by chatbot_source
...
def _cleanup_test_rows():
    ...
    try:
        with conn.cursor() as cur:
            ...
            cur.execute("DELETE FROM member_services_tickets WHERE resolution_notes = 'TEST_ROW_SAFE_TO_DELETE'")
    finally:
        conn.close()
