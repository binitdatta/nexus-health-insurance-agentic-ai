"""
Configuration for the Member Services department chatbot. Copied from
nursing-chatbot per the platform pattern — see the README for what
...
class Config:
    ...
    DEPT_CODE = os.getenv("DEPT_CODE", "MEMBERSVC")
    CHATBOT_SOURCE = os.getenv("CHATBOT_SOURCE", "membersvc-chatbot")
    DEPT_DISPLAY_NAME = os.getenv("DEPT_DISPLAY_NAME", "Member Services")
    ...
    KEYCLOAK_CLIENT_ID = os.getenv("KEYCLOAK_CLIENT_ID", "membersvc-chatbot-pkce")
    ...
    OAUTH_REDIRECT_URI = os.getenv("OAUTH_REDIRECT_URI", "http://localhost:5010/auth/callback")
    OAUTH_STATE_MAX_AGE_SECONDS = int(os.getenv("OAUTH_STATE_MAX_AGE_SECONDS", "300"))
    POST_LOGOUT_REDIRECT_URI = os.getenv("POST_LOGOUT_REDIRECT_URI", "http://localhost:5010/")
    ...
    LOG_FILE_NAME = os.getenv("LOG_FILE_NAME", "membersvc_chatbot.log")
    LOG_MAX_BYTES = int(os.getenv("LOG_MAX_BYTES", str(25 * 1024 * 1024)))
    LOG_BACKUP_COUNT = int(os.getenv("LOG_BACKUP_COUNT", "10"))
    LOG_LEVEL = os.getenv("LOG_LEVEL", "INFO")

    # --- Retrieval tuning -----------------------------------------------
    MAX_TICKET_ROWS = int(os.getenv("MAX_TICKET_ROWS", "25"))
