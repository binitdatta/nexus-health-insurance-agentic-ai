...
class TestConfig(Config):
    ...
    DEPT_CODE = "FINANCE"
    CHATBOT_SOURCE = "finance-chatbot-test"  # isolate test rows from real seed data by chatbot_source
...
def _cleanup_test_rows():
    ...
    try:
        with conn.cursor() as cur:
            ...
            cur.execute("DELETE FROM finance_transactions WHERE txn_reference LIKE 'TXNTEST%'")
    finally:
        conn.close()
