...
class TestConfig(Config):
    ...
    DEPT_CODE = "NURSING"
    CHATBOT_SOURCE = "nursing-chatbot-test"  # isolate test rows from real seed data by chatbot_source
...
def _cleanup_test_rows():
    ...
    try:
        with conn.cursor() as cur:
            ...
            cur.execute("DELETE FROM nursing_cases WHERE care_plan_notes = 'TEST_ROW_SAFE_TO_DELETE'")
    finally:
        conn.close()
