"""
Configuration for the Facility & Providers department chatbot. Copied
from billing-chatbot per the platform pattern — see the README for
what was changed to stand this one up.
"""
import os
...
class Config:
    ...
    DEPT_CODE = os.getenv("DEPT_CODE", "FACPROV")
    CHATBOT_SOURCE = os.getenv("CHATBOT_SOURCE", "facprov-chatbot")
    DEPT_DISPLAY_NAME = os.getenv("DEPT_DISPLAY_NAME", "Facility & Providers")
    ...
    KEYCLOAK_CLIENT_ID = os.getenv("KEYCLOAK_CLIENT_ID", "facprov-chatbot-pkce")
    ...
    OAUTH_REDIRECT_URI = os.getenv("OAUTH_REDIRECT_URI", "http://localhost:5006/auth/callback")
    OAUTH_STATE_MAX_AGE_SECONDS = int(os.getenv("OAUTH_STATE_MAX_AGE_SECONDS", "300"))
    POST_LOGOUT_REDIRECT_URI = os.getenv("POST_LOGOUT_REDIRECT_URI", "http://localhost:5006/")
    ...
    LOG_FILE_NAME = os.getenv("LOG_FILE_NAME", "facprov_chatbot.log")
    LOG_MAX_BYTES = int(os.getenv("LOG_MAX_BYTES", str(25 * 1024 * 1024)))
    LOG_BACKUP_COUNT = int(os.getenv("LOG_BACKUP_COUNT", "10"))
    LOG_LEVEL = os.getenv("LOG_LEVEL", "INFO")

    # --- Retrieval tuning -----------------------------------------------
    MAX_PROVIDER_ROWS = int(os.getenv("MAX_PROVIDER_ROWS", "25"))
