...
class TestConfig(Config):
    ...
    DEPT_CODE = "FACPROV"
    CHATBOT_SOURCE = "facprov-chatbot-test"  # isolate test rows from real seed data by chatbot_source
...
def _cleanup_test_rows():
    ...
    try:
        with conn.cursor() as cur:
            ...
            cur.execute("DELETE FROM providers WHERE provider_code LIKE 'PRVTEST%'")
    finally:
        conn.close()
