...
class TestConfig(Config):
    ...
    DEPT_CODE = "PRIORAUTH"
    CHATBOT_SOURCE = "priorauth-chatbot-test"  # isolate test rows from real seed data by chatbot_source
...
def _cleanup_test_rows():
    ...
    try:
        with conn.cursor() as cur:
            ...
            cur.execute("DELETE FROM prior_authorizations WHERE clinical_notes = 'TEST_ROW_SAFE_TO_DELETE'")
    finally:
        conn.close()
