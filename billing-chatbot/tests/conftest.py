...
class TestConfig(Config):
    ...
    DEPT_CODE = "BILLING"
    CHATBOT_SOURCE = "billing-chatbot-test"  # isolate test rows from real seed data by chatbot_source
...
def _cleanup_test_rows():
    ...
    try:
        with conn.cursor() as cur:
            ...
            cur.execute("DELETE FROM billing_records WHERE invoice_number LIKE 'INVTEST%'")
    finally:
        conn.close()
